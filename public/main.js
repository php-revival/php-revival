...
/***/ "./src/ts/Adders/BreadcrumbsArrowsAdder.ts":
/*!*************************************************!*\
  !*** ./src/ts/Adders/BreadcrumbsArrowsAdder.ts ***!
  \*************************************************/
...
var err_1 = __webpack_require__(/*! @/modules/err */ "./src/ts/modules/err.ts");
var BreadcrumbsArrowsAdder = /*#__PURE__*/function () {
  function BreadcrumbsArrowsAdder() {
    _classCallCheck(this, BreadcrumbsArrowsAdder);
    this.nextLink = '';
    this.prevLink = '';
    this.nextTitle = '';
    this.prevTitle = '';
    this.oldNextLink = document.querySelector(conf_1["default"].selectors.bread.next);
    this.oldPrevLink = document.querySelector(conf_1["default"].selectors.bread.prev);
    this.linksTarget = document.querySelector(conf_1["default"].selectors.docs.layoutContent);
  }
  return _createClass(BreadcrumbsArrowsAdder, [{
    key: "add",
    value: function add() {
    ...
    key: "removeOldArrows",
    value: function removeOldArrows() {
      this.oldNextLink.remove();
      this.oldPrevLink.remove();
    }
  }, {
    key: "getTitle",
    value: function getTitle(elem) {
      return elem.innerText.replace('« ', '').replace(' »', '').trim();
    }
  }, {
    key: "getLink",
    value: function getLink(elem) {
      var anchor = elem.querySelector('a');
      if (!anchor) {
        (0, err_1.warn)('Anchor not found in breadcrumbs arrow link');
        return '#';
      }
    ...
    key: "insertNewArrows",
    value: function insertNewArrows() {
      var rightLink = this.createArrowLink(this.nextTitle, this.nextLink, 'right');
      var leftLink = this.createArrowLink(this.prevTitle, this.prevLink, 'left');
      var container = this.createLinksContainer();
      container.appendChild(leftLink);
      container.appendChild(rightLink);
      this.linksTarget.appendChild(container);
    }
  }, {
    key: "createLinksContainer",
    value: function createLinksContainer() {
    ...
    key: "createArrowLink",
    value: function createArrowLink(title, link, direction) {
      var a = document.createElement('a');
      a.href = link;
      a.innerText = title;
      a.className = "php-revival-".concat(direction, "-arrow-link");
      return a;
    }
  }]);
}();
exports["default"] = BreadcrumbsArrowsAdder;

/***/ }),

/***/ "./src/ts/Adders/BrowserTypeAdder.ts":
/*!*******************************************!*\
  !*** ./src/ts/Adders/BrowserTypeAdder.ts ***!
  \*******************************************/
...
var BrowserTypeAdder = /*#__PURE__*/function () {
  function BrowserTypeAdder() {
    _classCallCheck(this, BrowserTypeAdder);
  }
  return _createClass(BrowserTypeAdder, [{
    key: "add",
    value: function add() {
      var insertClass = 'is-chrome';
...
exports["default"] = BrowserTypeAdder;
...
var conf_1 = __importDefault(__webpack_require__(/*! @/conf */ "./src/ts/conf.ts"));
var Tooltip_1 = __importDefault(__webpack_require__(/*! @/modules/Tooltip */ "./src/ts/modules/Tooltip.ts"));
var REMOVE_TOOLTIP_DELAY = 1000;
var CopyButtonAdder = /*#__PURE__*/function () {
  function CopyButtonAdder() {
    _classCallCheck(this, CopyButtonAdder);
  }
  return _createClass(CopyButtonAdder, [{
    key: "add",
    value: function add() {
      ...
      for (var _i = 0, _targets = targets; _i < _targets.length; _i++) {
        ...
        var icon = "<div title=\"Copy to a clipboard\" class=\"php-revival-copy-button\">".concat(copyIcon_1["default"], "</div>");
    ...
    value: function listenForButtonClick(targets) {
      ...
      try {
        var _loop = function _loop() {
          ...
          var copyIcon = target.querySelector(conf_1["default"].selectors.copyCodeButton);
          if (!copyIcon) {
            return 1; // continue
          }
          copyIcon.addEventListener('click', function () {
            var btn = target.querySelector('.php-revival-copy-button');
            if (btn) {
              _this.copyCode(target, btn);
            }
          });
        };
    ...
    key: "copyCode",
    value: function copyCode(target, btn) {
      var tooltip = new Tooltip_1["default"](btn);
      new CodeCopier_1["default"](target).copy().then(function () {
        return tooltip.display('Copied!', true);
      })["catch"](function (err) {
...
/***/ "./src/ts/Adders/Home/HomeLinksAdder.ts":
/*!**********************************************!*\
  !*** ./src/ts/Adders/Home/HomeLinksAdder.ts ***!
  \**********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var conf_1 = __importDefault(__webpack_require__(/*! @/conf */ "./src/ts/conf.ts"));
var err_1 = __webpack_require__(/*! @/modules/err */ "./src/ts/modules/err.ts");
var recommendedLinks_1 = __importDefault(__webpack_require__(/*! @/static/recommendedLinks */ "./src/ts/static/recommendedLinks.ts"));
var getStartedLinks_1 = __importDefault(__webpack_require__(/*! @/static/getStartedLinks */ "./src/ts/static/getStartedLinks.ts"));
var socialLinks_1 = __importDefault(__webpack_require__(/*! @/static/socialLinks */ "./src/ts/static/socialLinks.ts"));
var homeLinkTemplate_1 = __importDefault(__webpack_require__(/*! @/templates/homeLinkTemplate */ "./src/ts/templates/homeLinkTemplate.ts"));
var homeLinksSectionTemplate_1 = __importDefault(__webpack_require__(/*! @/templates/homeLinksSectionTemplate */ "./src/ts/templates/homeLinksSectionTemplate.ts"));
var linksIcons_1 = __importDefault(__webpack_require__(/*! @/static/linksIcons */ "./src/ts/static/linksIcons.ts"));
var DEFAULT_ICON_NAME = 'link-white.png';
var EVENT_LINKS = ['/conferences', '/cal.php'];
var HomeLinksAdder = /*#__PURE__*/function () {
  function HomeLinksAdder() {
    _classCallCheck(this, HomeLinksAdder);
    this.recommendedLinks = [];
    this.sidebarElem = document.querySelector(conf_1["default"].selectors.home.rightSidebar);
  }
  return _createClass(HomeLinksAdder, [{
    key: "add",
    value: function add() {
    ...
    key: "removeInitialLinks",
    value: function removeInitialLinks() {
      var innerElem = this.sidebarElem.querySelector('.inner');
      if (!innerElem) {
        (0, err_1.warn)('Could not find the inner element in the sidebar to remove it');
        return;
      }
      innerElem.remove();
    }
    ...
    key: "addLinksSection",
    value: function addLinksSection(links, header) {
      var _ref = (0, homeLinksSectionTemplate_1["default"])(header),
        section = _ref.section,
        targetForLinks = _ref.targetForLinks;
    ...
    key: "displayLinks",
    value: function displayLinks(sidebarSection) {
      setTimeout(function () {
        return sidebarSection.style.opacity = '1';
      }, 300);
    }
  }, {
    key: "getRecommendedLinks",
    value: function getRecommendedLinks() {
      var linkElements = this.recommendedLinks.filter(this.filterRecommendedLinks);
      var additionalLinks = recommendedLinks_1["default"].map(function (link) {
        return (0, homeLinkTemplate_1["default"])(link);
      });
      linkElements.push.apply(linkElements, _toConsumableArray(additionalLinks));
      return linkElements;
    }
  }, {
    key: "getEventsLinks",
    value: function getEventsLinks() {
      return this.recommendedLinks.filter(this.filterEventsLinks);
    }
  }, {
    key: "getGetStartedLinks",
    value: function getGetStartedLinks() {
      return getStartedLinks_1["default"].map(homeLinkTemplate_1["default"]);
    }
  }, {
    key: "filterRecommendedLinks",
    value: function filterRecommendedLinks(link) {
      return !EVENT_LINKS.some(function (href) {
        if (!link.dataset.url) {
          (0, err_1.warn)('No dataset.url found in the link');
          return false;
        }
    ...
    key: "filterEventsLinks",
    value: function filterEventsLinks(link) {
      return EVENT_LINKS.some(function (href) {
        if (!link.dataset.url) {
          (0, err_1.warn)('No dataset.url found in the link');
          return false;
    ...
    value: function getSocialLinks() {
      var linkElements = this.getSocialLinksFromPage();
      var additionalLinks = socialLinks_1["default"].map(function (link) {
        return (0, homeLinkTemplate_1["default"])(link);
      });
      linkElements.push.apply(linkElements, _toConsumableArray(additionalLinks));
      return linkElements;
    ...
    key: "getRecommendedLinksFromPage",
    value: function getRecommendedLinksFromPage() {
      var links = [];
      var elements = this.sidebarElem.querySelectorAll('.inner > .panel');
      var panels = Array.from(elements);
      for (var _i = 0, _panels = panels; _i < _panels.length; _i++) {
        var panel = _panels[_i];
        if (!this.childrenHaveLinks(panel.children)) {
          continue;
        }
        var link = this.getLinkFromChildren(panel.children);
        if (!link) {
          continue;
        }
        var nestedList = panel.querySelector('.body > ul');
        if (nestedList) {
          link.nestedList = nestedList;
        }
        links.push(link);
      }
    ...
    key: "getSocialLinksFromPage",
    value: function getSocialLinksFromPage() {
      var links = [];
      var selector = '.inner > .social-media ul li a';
      var elements = this.sidebarElem.querySelectorAll(selector);
      var anchorTags = Array.from(elements);
      for (var _i2 = 0, _anchorTags = anchorTags; _i2 < _anchorTags.length; _i2++) {
        var anchor = _anchorTags[_i2];
        if (anchor.tagName !== 'A') {
          (0, err_1.warn)("Expected an anchor tag, got ".concat(anchor.tagName));
          continue;
        }
        var element = anchor;
    ...
    key: "childrenHaveLinks",
    value: function childrenHaveLinks(children) {
    ...
    key: "getLinkFromChildren",
    value: function getLinkFromChildren(children) {
      ...
      (0, err_1.err)('No link found in the children of the panel');
      return null;
    }
  }, {
    key: "getIconName",
    value: function getIconName(title) {
      var _iterator4 = _createForOfIteratorHelper(linksIcons_1["default"]),
        _step4;
      try {
...
/***/ "./src/ts/Adders/Home/RecommendedVideoAdder.ts":
/*!*****************************************************!*\
  !*** ./src/ts/Adders/Home/RecommendedVideoAdder.ts ***!
  \*****************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var recommendedVideosSectionTemplate_1 = __importDefault(__webpack_require__(/*! @/templates/recommendedVideosSectionTemplate */ "./src/ts/templates/recommendedVideosSectionTemplate.ts"));
var recommendedVideos_1 = __importDefault(__webpack_require__(/*! @/static/recommendedVideos */ "./src/ts/static/recommendedVideos.ts"));
var conf_1 = __importDefault(__webpack_require__(/*! @/conf */ "./src/ts/conf.ts"));
var listenEvent_1 = __importDefault(__webpack_require__(/*! @/modules/listenEvent */ "./src/ts/modules/listenEvent.ts"));
var loadMoreVideosButtonTemplate_1 = __importDefault(__webpack_require__(/*! @/templates/loadMoreVideosButtonTemplate */ "./src/ts/templates/loadMoreVideosButtonTemplate.ts"));
var recommendedVideoTemplate_1 = __importDefault(__webpack_require__(/*! @/templates/recommendedVideoTemplate */ "./src/ts/templates/recommendedVideoTemplate.ts"));
var AMOUNT_OF_VIDEOS_TO_SHOW = 20;
var RecommendedVideoAdder = /*#__PURE__*/function () {
  function RecommendedVideoAdder() {
    ...
    this.targetForVideos = null;
    this.loadMoreBtn = null;
    this.sidebarElem = document.querySelector(conf_1["default"].selectors.home.rightSidebar);
  }
  return _createClass(RecommendedVideoAdder, [{
    key: "add",
    value: function add() {
      ...
      this.insertVideos(recommendedVideos_1["default"]);
      this.showSectionForVideos();
      (0, listenEvent_1["default"])(conf_1["default"].events.videoTagSelected, this.filterVideos.bind(this));
    }
  }, {
    key: "showSectionForVideos",
    value: function showSectionForVideos() {
      var _this = this;
      setTimeout(function () {
        if (_this.sidebarSection) {
          _this.sidebarSection.style.opacity = '1';
        }
      }, 300);
    }
  }, {
    key: "isNotHomePage",
    value: function isNotHomePage() {
      return window.location.pathname !== '/';
    }
  }, {
    key: "filterVideos",
    value: function filterVideos(tagLabel) {
      var videos = recommendedVideos_1["default"].filter(function (v) {
        return v.tags.includes(tagLabel);
      });
      this.insertVideos(videos);
    }
  }, {
    key: "removeLoadMoreBtn",
    value: function removeLoadMoreBtn() {
      if (this.loadMoreBtn) {
    ...
    value: function createLoadMoreButton() {
      var loadMoreButton = (0, loadMoreVideosButtonTemplate_1["default"])();
      this.loadMoreBtn = loadMoreButton;
      return loadMoreButton;
    }
  }, {
    key: "clearVideos",
    value: function clearVideos() {
    ...
    value: function insertMoreVideosAfterClick() {
      ...
      this.loadMoreBtn.addEventListener('click', function () {
        var _this2$videosToDispla;
        var restVideos = _this2.excludeVideosAlreadyDisplayed(_this2.restOfVideos);
        var additionalVideos = restVideos.slice(0, AMOUNT_OF_VIDEOS_TO_SHOW);
        (_this2$videosToDispla = _this2.videosToDisplay).push.apply(_this2$videosToDispla, _toConsumableArray(additionalVideos));
        _this2.restOfVideos = restVideos.slice(AMOUNT_OF_VIDEOS_TO_SHOW);
        _this2.appendVideos(additionalVideos);
      });
    }
  }, {
    key: "insertSectionForVideos",
    value: function insertSectionForVideos() {
      var _ref = (0, recommendedVideosSectionTemplate_1["default"])(),
        section = _ref.section,
        targetForCards = _ref.targetForCards;
    ...
    key: "insertVideos",
    value: function insertVideos(allVideos) {
      if (!this.targetForVideos) {
      ...
      if (allVideos.length > AMOUNT_OF_VIDEOS_TO_SHOW) {
        ...
        var videosToShow = this.excludeVideosAlreadyDisplayed(allVideos);
      ...
      this.clearVideos();
      var _iterator = _createForOfIteratorHelper(this.videosToDisplay),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var video = _step.value;
          var videoElem = (0, recommendedVideoTemplate_1["default"])(video);
    ...
    key: "excludeVideosAlreadyDisplayed",
    value: function excludeVideosAlreadyDisplayed(videos) {
      var _this3 = this;
      return videos.filter(function (v) {
        return !_this3.videosToDisplay.includes(v);
      });
    }
  }, {
    key: "appendVideos",
...
/***/ "./src/ts/Adders/SandboxButtonAdder.ts":
/*!*********************************************!*\
  !*** ./src/ts/Adders/SandboxButtonAdder.ts ***!
  \*********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var conf_1 = __importDefault(__webpack_require__(/*! @/conf */ "./src/ts/conf.ts"));
var err_1 = __webpack_require__(/*! @/modules/err */ "./src/ts/modules/err.ts");
var cubeIcon_1 = __importDefault(__webpack_require__(/*! @/templates/icons/cubeIcon */ "./src/ts/templates/icons/cubeIcon.ts"));
var CodeCopier_1 = __importDefault(__webpack_require__(/*! @/modules/CodeCopier */ "./src/ts/modules/CodeCopier.ts"));
...
var SandboxButtonAdder = /*#__PURE__*/function () {
  function SandboxButtonAdder() {
    _classCallCheck(this, SandboxButtonAdder);
  }
  return _createClass(SandboxButtonAdder, [{
    key: "add",
    value: function add() {
      var targetsList = document.querySelectorAll(conf_1["default"].selectors.targetForCodeExamples);
      var targets = Array.from(targetsList);
      ...
      for (var _i = 0, _targets = targets; _i < _targets.length; _i++) {
        var target = _targets[_i];
        var icon = "<div title=\"Edit in Sandbox\" class=\"php-revival-sandbox-button\">".concat(cubeIcon_1["default"], "</div>");
        target.insertAdjacentHTML('afterbegin', icon);
      }
      this.listenForButtonClick(targets);
    }
    ...
    value: function listenForButtonClick(targets) {
      ...
      try {
        var _loop = function _loop() {
          var target = _step.value;
          var playIcon = target.querySelector(conf_1["default"].selectors.sandboxCodeButton);
          if (!playIcon) {
            return 1; // continue
          }
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.n) {
            ...
            case 2:
              _context2.p = 2;
              _t = _context2.v;
              (0, err_1.err)('Code coping failed', _t);
...
exports["default"] = SandboxButtonAdder;
...
var CodeSampleModifier = /*#__PURE__*/function () {
  ...
  return _createClass(CodeSampleModifier, [{
    key: "modify",
...
var ContributeModifier = /*#__PURE__*/function () {
  ...
  return _createClass(ContributeModifier, [{
    key: "modify",
    value: function modify() {
...
var HomeHeroModifier = /*#__PURE__*/function () {
  ...
  return _createClass(HomeHeroModifier, [{
    key: "modify",
    value: function modify() {
      ...
      this.logoElem = hero.querySelector('.hero__logo');
      this.textElem = hero.querySelector('.hero__text');
      this.buttonsElem = hero.querySelector('.hero__actions');
      this.wrapInRow(hero);
...
/***/ "./src/ts/Modifiers/RunCodeButtonModifier.ts":
/*!***************************************************!*\
  !*** ./src/ts/Modifiers/RunCodeButtonModifier.ts ***!
  \***************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var isCaretInsideElem_1 = __importDefault(__webpack_require__(/*! @/modules/isCaretInsideElem */ "./src/ts/modules/isCaretInsideElem.ts"));
var Tooltip_1 = __importDefault(__webpack_require__(/*! @/modules/Tooltip */ "./src/ts/modules/Tooltip.ts"));
var RunCodeButtonModifier = /*#__PURE__*/function () {
  function RunCodeButtonModifier() {
    _classCallCheck(this, RunCodeButtonModifier);
  }
  return _createClass(RunCodeButtonModifier, [{
    key: "modify",
    value: function modify() {
      var wrappers = document.querySelectorAll('.example .example-contents');
    ...
    key: "modifyButton",
    value: function modifyButton(btn, wrapper) {
      var codeBlock = wrapper.querySelector('.phpcode');
      if (!codeBlock) {
        (0, err_1.warn)('Code block not found. Cannot modify the "Run code" button');
        return;
      }
      btn.innerHTML = playIcon_1["default"];
      btn.classList.add('php-revival-run-button');
      codeBlock.appendChild(btn);
      btn.addEventListener('click', function () {
        new Tooltip_1["default"](btn).display('Code executed below', true);
      });
    }
  }, {
    key: "listenForKeyboardEvents",
    value: function listenForKeyboardEvents(btn, wrapper) {
      wrapper.addEventListener('keydown', function (e) {
        if (!(0, isCaretInsideElem_1["default"])(wrapper)) {
          return;
        }
...
exports["default"] = RunCodeButtonModifier;

/***/ }),

/***/ "./src/ts/Modifiers/ShowPageModifier.ts":
/*!**********************************************!*\
  !*** ./src/ts/Modifiers/ShowPageModifier.ts ***!
  \**********************************************/
/***/ ((__unused_webpack_module, exports) => {
...
var ToggleCommentsModifier = /*#__PURE__*/function () {
  ...
  return _createClass(ToggleCommentsModifier, [{
    key: "modify",
    value: function modify() {
...
var RecommendedVideoAdder_1 = __importDefault(__webpack_require__(/*! @/Adders/Home/RecommendedVideoAdder */ "./src/ts/Adders/Home/RecommendedVideoAdder.ts"));
var HomeLinksAdder_1 = __importDefault(__webpack_require__(/*! @/Adders/Home/HomeLinksAdder */ "./src/ts/Adders/Home/HomeLinksAdder.ts"));
...
var SandboxButtonAdder_1 = __importDefault(__webpack_require__(/*! @/Adders/SandboxButtonAdder */ "./src/ts/Adders/SandboxButtonAdder.ts"));
var RunCodeButtonModifier_1 = __importDefault(__webpack_require__(/*! @/Modifiers/RunCodeButtonModifier */ "./src/ts/Modifiers/RunCodeButtonModifier.ts"));
var BreadcrumbsArrowsAdder_1 = __importDefault(__webpack_require__(/*! @/Adders/BreadcrumbsArrowsAdder */ "./src/ts/Adders/BreadcrumbsArrowsAdder.ts"));
var BrowserTypeAdder_1 = __importDefault(__webpack_require__(/*! @/Adders/BrowserTypeAdder */ "./src/ts/Adders/BrowserTypeAdder.ts"));
var ShowPageModifier_1 = __importDefault(__webpack_require__(/*! @/Modifiers/ShowPageModifier */ "./src/ts/Modifiers/ShowPageModifier.ts"));
new Extension_1["default"]().applyModifiers([new ShowPageModifier_1["default"](), new CodeSampleModifier_1["default"](), new HomeHeroModifier_1["default"](), new ContributeModifier_1["default"](), new ToggleCommentsModifier_1["default"](), new RunCodeButtonModifier_1["default"]()]).applyAdders([new CopyButtonAdder_1["default"](), new BrowserTypeAdder_1["default"](), new HomeLinksAdder_1["default"](), new SandboxButtonAdder_1["default"](), new BreadcrumbsArrowsAdder_1["default"](), new RecommendedVideoAdder_1["default"]()]);
...
var CodeCopier = /*#__PURE__*/function () {
  ...
  return _createClass(CodeCopier, [{
    key: "copy",
    value: function copy() {
      return __awaiter(this, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee() {
        var code, cleanCode;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              ...
              (0, err_1.warn)('Code element not found for copying');
              return _context.a(2, null);
            case 1:
              cleanCode = this.cleanCode(code.innerHTML);
              return _context.a(2, this.copyTextToClipboard(cleanCode, this.target));
          }
        }, _callee, this);
      }));
    }
...
var MAIN_CLASS = 'php-revival-tooltip';
var RED_CLASS = 'php-revival-tooltip--red';
var GREEN_CLASS = 'php-revival-tooltip--green';
var TOGGLE_CLASS = 'php-revival-tooltip--show';
...
var Tooltip = /*#__PURE__*/function () {
  ...
  return _createClass(Tooltip, [{
    key: "removeAfter",
    value: function removeAfter() {
      var _this = this;
      setTimeout(function () {
        _this.tooltip.classList.remove(TOGGLE_CLASS);
        setTimeout(function () {
          return _this.tooltip.remove();
        }, 300);
      }, REMOVE_AFTER);
    }
  }, {
    key: "display",
    value: function display(text, isSuccess) {
      var _this2 = this;
      this.tooltip.setAttribute('data-text', text);
      this.tooltip.classList.add(isSuccess ? GREEN_CLASS : RED_CLASS);
      setTimeout(function () {
        _this2.tooltip.classList.add(TOGGLE_CLASS);
        _this2.removeAfter();
      }, 100);
    }
  }, {
...
/***/ "./src/ts/modules/dispatchEvent.ts":
/*!*****************************************!*\
  !*** ./src/ts/modules/dispatchEvent.ts ***!
  \*****************************************/
/***/ ((__unused_webpack_module, exports) => {
...
function warn(text, err) {
  console.warn("[PHP Revival]: ".concat(text), err);
}
function err(text, err) {
  console.error("[PHP Revival]: ".concat(text), err);
}
function info(text, err) {
  console.info("[PHP Revival]: ".concat(text), err);
}
...
/***/ "./src/ts/modules/isCaretInsideElem.ts":
/*!*********************************************!*\
  !*** ./src/ts/modules/isCaretInsideElem.ts ***!
  \*********************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./src/ts/static/getStartedLinks.ts":
/*!******************************************!*\
  !*** ./src/ts/static/getStartedLinks.ts ***!
  \******************************************/
/***/ ((__unused_webpack_module, exports) => {
...
exports["default"] = getStartedLinks;

/***/ }),

/***/ "./src/ts/static/linksIcons.ts":
/*!*************************************!*\
  !*** ./src/ts/static/linksIcons.ts ***!
  \*************************************/
/***/ ((__unused_webpack_module, exports) => {
...
var linksIcons = [{
  linkTitle: 'The PHP Foundation',
  iconName: 'phpfoundation.png'
}, {
  linkTitle: 'Upcoming conferences',
  iconName: 'talk.png'
}, {
  linkTitle: 'User Group Events',
  iconName: 'events.png'
}, {
  ...
  iconName: 'mastodon.png'
}];
exports["default"] = linksIcons;

/***/ }),

/***/ "./src/ts/static/recommendedLinks.ts":
/*!*******************************************!*\
  !*** ./src/ts/static/recommendedLinks.ts ***!
  \*******************************************/
/***/ ((__unused_webpack_module, exports) => {
...
exports["default"] = recommendedLinks;

/***/ }),

/***/ "./src/ts/static/recommendedVideos.ts":
/*!********************************************!*\
  !*** ./src/ts/static/recommendedVideos.ts ***!
  \********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var types_1 = __webpack_require__(/*! @/types */ "./src/ts/types/index.ts");
var recommendedVideos = (0, arrShuffle_1["default"])([{
  title: 'Factory Pattern - Object Oriented PHP Tutorial',
  link: 'https://youtu.be/H5lor4wyl1Y',
  img: 'object-oriented-php-tutorial.jpg',
  date: '2019-12-02',
  tags: [types_1.VideoTag.All]
}, {
  ...
  date: '2020-11-16',
  tags: [types_1.VideoTag.All, types_1.VideoTag.Laravel]
}, {
  ...
  date: '2023-11-24',
  tags: [types_1.VideoTag.All, types_1.VideoTag.Symfony]
}, {
...
var recommendedLinks = [{
  href: 'https://www.linkedin.com/company/phpnet/',
...
/***/ "./src/ts/templates/homeLinkTemplate.ts":
/*!**********************************************!*\
  !*** ./src/ts/templates/homeLinkTemplate.ts ***!
  \**********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
function createLink(img, span, link) {
  var a = document.createElement('a');
  a.href = link.href;
  a.target = '_blank';
  a.appendChild(img);
...
/***/ "./src/ts/templates/homeLinksSectionTemplate.ts":
/*!******************************************************!*\
  !*** ./src/ts/templates/homeLinksSectionTemplate.ts ***!
  \******************************************************/
...
var homeSidebarTemplate_1 = __webpack_require__(/*! @/templates/homeSidebarTemplate */ "./src/ts/templates/homeSidebarTemplate.ts");
exports["default"] = function (header) {
  var section = (0, homeSidebarTemplate_1.createSection)();
  var targetForLinks = createTargetForLinks();
  var title = (0, homeSidebarTemplate_1.createTitle)(header);
  section.appendChild(title);
  section.appendChild(targetForLinks);
  return {
    section: section,
    targetForLinks: targetForLinks
  };
};
function createTargetForLinks() {
  var targetForCards = document.createElement('div');
...
/***/ "./src/ts/templates/homeSidebarTemplate.ts":
/*!*************************************************!*\
  !*** ./src/ts/templates/homeSidebarTemplate.ts ***!
  \*************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
exports.createSection = exports.createTitle = void 0;
var getImageUrl_1 = __importDefault(__webpack_require__(/*! @/modules/getImageUrl */ "./src/ts/modules/getImageUrl.ts"));
var createTitle = function createTitle(header, iconName) {
  var title = document.createElement('h2');
  title.className = 'php-revival-home-sidebar-section__title';
  title.innerText = header;
  if (iconName) {
    var img = document.createElement('img');
    img.src = (0, getImageUrl_1["default"])("icons/".concat(iconName));
    img.alt = header + ' icon';
    title.prepend(img);
  }
  return title;
...
/***/ "./src/ts/templates/icons/cubeIcon.ts":
/*!********************************************!*\
  !*** ./src/ts/templates/icons/cubeIcon.ts ***!
  \********************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./src/ts/templates/loadMoreVideosButtonTemplate.ts":
/*!**********************************************************!*\
  !*** ./src/ts/templates/loadMoreVideosButtonTemplate.ts ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
/***/ "./src/ts/templates/recommendedVideoTemplate.ts":
/*!******************************************************!*\
  !*** ./src/ts/templates/recommendedVideoTemplate.ts ***!
  \******************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
exports["default"] = function (video) {
  ...
  var src = (0, getImageUrl_1["default"])("recommended-videos/".concat(video.img));
...
function createDateElement(date) {
  ...
  small.textContent = (0, moment_1["default"])(date).format('ll');
  return small;
}

/***/ }),

/***/ "./src/ts/templates/recommendedVideosSectionTemplate.ts":
/*!**************************************************************!*\
  !*** ./src/ts/templates/recommendedVideosSectionTemplate.ts ***!
  \**************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var homeSidebarTemplate_1 = __webpack_require__(/*! @/templates/homeSidebarTemplate */ "./src/ts/templates/homeSidebarTemplate.ts");
var types_1 = __webpack_require__(/*! @/types */ "./src/ts/types/index.ts");
var dispatchEvent_1 = __importDefault(__webpack_require__(/*! @/modules/dispatchEvent */ "./src/ts/modules/dispatchEvent.ts"));
var conf_1 = __importDefault(__webpack_require__(/*! @/conf */ "./src/ts/conf.ts"));
exports["default"] = function () {
  var section = (0, homeSidebarTemplate_1.createSection)();
  var targetForCards = createTargetForVideos();
  var title = (0, homeSidebarTemplate_1.createTitle)('Recommended Videos', 'youtube.webp');
  var tags = createTags();
  section.appendChild(title);
  ...
  return {
    section: section,
    targetForCards: targetForCards
  };
};
function createTargetForVideos() {
  var targetForCards = document.createElement('div');
...
function createTags() {
  var tags = [];
  var allTags = Object.values(types_1.VideoTag);
  var _loop = function _loop() {
    var tagLabel = _allTags[_i];
    var tagElem = createTag(tagLabel);
    if (tagLabel === types_1.VideoTag.All) {
    ...
    tagElem.addEventListener('click', function (e) {
      ...
      (0, dispatchEvent_1["default"])(conf_1["default"].events.videoTagSelected, tagLabel);
    });
    tags.push(tagElem);
  };
  for (var _i = 0, _allTags = allTags; _i < _allTags.length; _i++) {
    _loop();
  }
  var container = document.createElement('div');
  container.className = 'php-revival-recommended-videos-section__tags';
  container.append.apply(container, tags);
  return container;
}
...
(function (VideoTag) {
  VideoTag["All"] = "all";
  VideoTag["Laravel"] = "laravel";
  VideoTag["Symfony"] = "symfony";
})(VideoTag || (exports.VideoTag = VideoTag = {}));
...
/******/ 	__webpack_require__.O(undefined, ["public/main"], () => (__webpack_require__("./src/ts/app.ts")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["public/main"], () => (__webpack_require__("./src/sass/app.sass")))
